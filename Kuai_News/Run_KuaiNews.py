...
def backtohome(d):
    try:
        for n in range(8):
            d(resourceId="com.ifeng.kuaitoutiao:id/bottom_back").click_exists(timeout=3)
            if d(resourceId="com.ifeng.kuaitoutiao:id/tab_menu_item_rb_news",text="新闻").exists:
                d(resourceId="com.ifeng.kuaitoutiao:id/tab_menu_item_rb_news ", text="新闻").click_exists(timeout=2)
                break
    except:
        pass
    dd(resourceId="com.ifeng.kuaitoutiao:id/tab_menu_item_rb_news"，text="新闻").click_exists(timeout=2)
    return d
